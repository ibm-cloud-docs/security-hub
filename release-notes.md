...
### 15 April 2026
{: #security-services-date-for-update-apr-1526}
{: release-note}

Version 4.2.15 of the Cloud foundation for security and observability deployable architecture deployable architecture is available
:   The Cloud foundation for security and observability deployable architecture deployable architecture version 4.2.15 [is released](/catalog#deployable_architecture){: external}.
...
## February 2026
{: #security-services-date-for-update-2026-02}
{: release-note}

### 17 February 2026
{: #security-services-date-for-update-feb-1726}
{: release-note}

Version 4.2.14 of the Cloud foundation for security and observability deployable architecture deployable architecture is available
:   The Cloud foundation for security and observability deployable architecture deployable architecture version 4.2.14 [is released](/catalog#deployable_architecture){: external}.

   - Improved UI experience for several inputs related to existing infrastructure.
   - When you upgrade, all deployable architecture stack members are updated to their latest versions.

## December 2025
{: #security-services-date-for-update-2025-12}
{: release-note}

### 4 December 2025
{: #security-services-date-for-update-dec-0425}
{: release-note}

Version 4.1.1 of the Cloud foundation for security and observability deployable architecture deployable architecture is available
:   The Cloud foundation for security and observability deployable architecture deployable architecture version 4.1.1 [is released](/catalog#deployable_architecture){: external}.
